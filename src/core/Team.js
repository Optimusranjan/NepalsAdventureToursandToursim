            ...
            <div className="border shadow rounded my-3 p-2">
    		    <div className="card profile-card-2">
                    ...
                    <div className="card-body pt-5">
                        ...
                        <h5 className="card-title font-weight-bold">Ranjan Rimal</h5>
                        <p className="card-text">CEO of Nepal Adventure Tours and Tourism</p>
                        <div className="p-2">
                        <h6 className="text-success border-bottom border-info font-weight-bold">Skills</h6>
                        <ul type="none">
                        <li className="text-warning text-center">Android & Web Development</li>
                        ...
                        Analytical and detail oriented Android app developer professional with stellar
                         communication skills. Adept at bringing all team members together to reach a
                          common goal on time and under budget. Conceptualizing app solutions with the
                           latest technology, design theory, and a large dose of creativity.</p>
                        </ul>
                        </div>
                        <div className="text-center border-top border-success pt-3 pb-1" id="logoofcard">
                        <a href="https://github.com/Optimusranjan">
                        <i className="fab fa-github fa-2x" aria-hidden="true"></i></a> &nbsp;&nbsp;&nbsp;
                        <a href="https://twitter.com/ranjanrimal"> 
                        <i class="fab fa-twitter fa-2x" aria-hidden="true"></i>
                        </a> &nbsp;&nbsp;&nbsp;
                        <a href="https://www.linkedin.com/in/ranjan-rimal-559351163/"> <i class="fab fa-linkedin fa-2x" aria-hidden="true"></i>
                        </a>&nbsp;&nbsp;&nbsp;
                        <a href="https://ranjan.medium.com/"> <i class="fab fa-medium fa-2x" aria-hidden="true"></i>
                        </a>
                        </div>
                    </div>
                </div>
