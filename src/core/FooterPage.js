      ...
      <MDBContainer className="mt-5 mb-4 text-center text-md-left">
        <MDBRow className="mt-3">
          <MDBCol md="3" lg="4" xl="3" className="mb-4 dark-grey-text">
            ...
            Nepal Adventure Tours & Tourism
            </h6>
            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{ width: "70px" }} />
            <p className="text-justify">
            Develop Nepal's adventure tours and tourism to enhance the
            experience of life and boost the revenue of economy with the implementation 
            of appropriate solution to uplift sustainability.
            </p>
          </MDBCol>
          ...
          <MDBCol md="4" lg="3" xl="3" className="mb-4 dark-grey-text">
            ...
            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{ width: "60px" }} />
            <p>
              <i className="fa fa-home mr-3" /> Kathmandu, 44600, Nepal
            </p>
            <p>
              <i className="fa fa-envelope mr-3" /> info@nepaladventuretours.com
            </p>
            <p>
              <i className="fa fa-phone mr-3" /> + 977 9817075892
            </p>
            <p>
              <i className="fa fa-print mr-3" /> + 977 9842689741
            </p>
          </MDBCol>
        </MDBRow>
      </MDBContainer>
      <div className="footer-copyright text-center py-3" style={{
        backgroundColor : '#64aab0'
      }}>
        <MDBContainer fluid>
          &copy; {new Date().getFullYear()} Copyright:{" "}
          <a href="https://github.com/optimusranjan"> www.nepaladventuretours.com</a>
        </MDBContainer>
      </div>
    </MDBFooter>
  );
