...
const Home = () => {
    ...
    return (
        ...
        <HomeIcon />
        <div className="pt-3">
        <h2 className="text-center h2 mt-3 mb-3" id="home-popularplace"><span style={{color:"#4caf50"}}>Popular
        </span> Destination</h2>
            <div className="row">
            ...
            <h2 className="text-center h2 mt-3 mb-3"><span style={{color:"#4caf50"}}>New </span>Places to Visit</h2>
            <div className="row">
