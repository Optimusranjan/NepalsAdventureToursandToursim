    ...
    const signUpForm = () => (
        ...
        <h2 className="my-2 p-2 text-dark font-weight-bold text-center h2 border-bottom">Signup</h2>
            ...
            <div className="col-xs-12 col-sm-6 col-md-5 rounded-right my-3 shadow-lg" id="signup-intro">
                <h2 className="text-white text-center my-3 p-2 h2">Welcome to Nepal Adventure Tour & Tourism</h2>
                ...
                <p className="h5 text-center text-white py-1 my-1 font-weight-bold">Let's Explore the Nepal !!!!</p>
