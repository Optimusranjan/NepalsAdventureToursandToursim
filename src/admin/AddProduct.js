    ...
    const newPostForm = () => (
        ...
        <form className="mb-3" onSubmit={clickSubmit}>
            ...
            <div className="form-group">
                ...
                <input onChange={handleChange('youtubelink')} type="text" className="form-control" 
                value={youtubelink} placeholder=" not this -https://youtu.be/Zcz34Zd5MZs but this only- a4pi2zKbf8Q" />
            </div>
